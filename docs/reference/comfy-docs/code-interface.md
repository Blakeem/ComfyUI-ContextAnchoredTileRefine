> **Source:** https://docs.comfy.org/custom-nodes/backend/interface (mdx source: `custom-nodes/backend/interface.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs); page title "Code Interface")
> **Doc set version:** docs.comfy.org (current, main branch)
> **Retrieved:** 2026-07-22

# Code Interface

What are custom nodes and how are they used?
