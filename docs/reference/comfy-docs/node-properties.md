> **Source:** https://docs.comfy.org/custom-nodes/backend/server_overview (mdx source: `custom-nodes/backend/server_overview.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs); page title "Properties")
