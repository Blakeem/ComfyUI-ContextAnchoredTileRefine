> **Source:** https://docs.comfy.org/custom-nodes/backend/datatypes (mdx source: `custom-nodes/backend/datatypes.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs))
