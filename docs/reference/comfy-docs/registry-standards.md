> **Source:** https://docs.comfy.org/registry/standards (mdx source: `registry/standards.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs); page title "Standards")
