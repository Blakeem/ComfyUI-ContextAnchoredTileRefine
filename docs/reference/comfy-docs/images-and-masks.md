> **Source:** https://docs.comfy.org/custom-nodes/backend/images_and_masks (mdx source: `custom-nodes/backend/images_and_masks.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs))
