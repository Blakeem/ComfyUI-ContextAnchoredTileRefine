> **Source:** https://docs.comfy.org/custom-nodes/backend/snippets (mdx source: `custom-nodes/backend/snippets.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs); page title "Annotated Examples")
