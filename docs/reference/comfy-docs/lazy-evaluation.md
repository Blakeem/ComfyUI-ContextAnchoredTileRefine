> **Source:** https://docs.comfy.org/custom-nodes/backend/lazy_evaluation (mdx source: `custom-nodes/backend/lazy_evaluation.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs))
