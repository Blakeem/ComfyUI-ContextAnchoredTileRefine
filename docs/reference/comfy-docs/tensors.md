> **Source:** https://docs.comfy.org/custom-nodes/backend/tensors (mdx source: `custom-nodes/backend/tensors.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs); page title "Working with torch.Tensor")
