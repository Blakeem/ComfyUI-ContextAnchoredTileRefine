> **Source:** https://docs.comfy.org/custom-nodes/backend/lifecycle (mdx source: `custom-nodes/backend/lifecycle.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs))
