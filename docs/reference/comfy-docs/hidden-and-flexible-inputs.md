> **Source:** https://docs.comfy.org/custom-nodes/backend/more_on_inputs (mdx source: `custom-nodes/backend/more_on_inputs.mdx` in [Comfy-Org/docs](https://github.com/Comfy-Org/docs); page title "Hidden and Flexible inputs")
